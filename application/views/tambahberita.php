                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <?php echo form_open('backend/addartikelprocess'); ?>  
                            <input class="form-control" type="text" name="judul" maxlength="250" id="judul" placeholder="Judul Berita" style="width:250px;">  
                            <br>      
                            <div class="date" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                            <input class="form-control datepicker"  data-date-format="yyyy-mm-dd" type="text" name="tanggal" style="width:250px" placeholder="Tanggal" >
                            </div>
                            <input type="hidden" id="dtp_input2" value=""/>
                            <br> 
                            <input class="form-control" type="text" name="posted_by" maxlength="250" id="posted_by" placeholder="Posted By" style="width:250px;">         
                            <br>
                                <textarea id="textareas" rows="15" cols="50" name="isi_berita" style="width:80%;"></textarea> 
                                <br>                         
