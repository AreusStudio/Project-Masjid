                    ...
                    <div class="panel panel-default">
                        ...
                        ?>
                            <div class="alert alert-success">
                                <a href="#" class="alert-link">Berhasil Menambahkan Foto</a>
                            </div>
                        <?php 
                        } } ?>  

                        <?php echo form_open_multipart('backend/addfotoprocess'); ?>   <!-- ini tambahannya -->
                        <?php echo form_open('backend/addfotoprocess'); ?>  
