...
tinyMCE.init({
    ...
    function fileBrowserCallBack(field_name, url, type, win) {
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Daftar Laporan Kegiatan</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <?php 
                        $u = 1;
                        foreach($kegiatan->result() as $photo) { ?>
                        <tr>

                            <td><?php echo $u?></td>
                            <td><?php echo $photo->Nama_kegiatan?></td>
                            <td>
                                <?php echo $photo->file_kegiatan?>
                            </td>
                            <!--<th>
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
                        <h3>Ubah Data Kegiatan</h3><br>
                        <form role="form" action="ubahkegiatanprocess" id="update-kegiatan" method="post" enctype="multipart/form-data">
