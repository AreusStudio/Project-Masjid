...
font-size:12px;
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Tambah Contact</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
         <!-- /.row -->
                    ...
                    <div class="panel panel-default">
                        ...
                        ?>
                            <div class="alert alert-success">
                                <a href="#" class="alert-link">Berhasil Menambahkan Contact</a>
                            </div>
                        <?php 
                        } } ?>  

                        <?php echo form_open_multipart('backend/addcontactprocess'); ?>   <!-- ini tambahannya -->
                        <?php echo form_open('backend/addcontactprocess'); ?>  
                            <input class="form-control" type="text" name="lokasi" maxlength="250" id="lokasi" placeholder="Lokasi" style="width:250px;">  
                            <br> 
                            <input class="form-control" type="text" name="telp" maxlength="250" id="telp" placeholder="Telepon" style="width:250px;">         
                            <br>
