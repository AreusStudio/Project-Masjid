...
font-size:12px;
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Tambah Foto</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
         <!-- /.row -->
                    ...
                    <div class="panel panel-default">
                        ...
                        ?>
                            <div class="alert alert-success">
                                <a href="#" class="alert-link">Berhasil Menambahkan Video</a>
                            </div>
                        <?php 
                        } } ?>  

                        <?php echo form_open_multipart('backend/addvideoprocess'); ?>   <!-- ini tambahannya -->
                        <?php echo form_open('backend/addvideoprocess'); ?>  
                            <input class="form-control" type="text" name="judul" maxlength="250" id="judul" placeholder="Judul Video" style="width:250px;">  
                            <br>           
                            <br>
                            <input class="form-control" type="text" name="url_video" maxlength="250" id="url_video" placeholder="Url Video" style="width:250px;">         
                            <br>
