...
font-size:12px;
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Tambah Data Slide</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
         <!-- /.row -->
                    ...
                    <div class="panel panel-default">
                        ...
                        ?>
                            <div class="alert alert-success">
                                <a href="#" class="alert-link">Berhasil Menambahkan Data Slide</a>
                            </div>
                        <?php 
                        } } ?>  

                        <?php echo form_open_multipart('backend/addslideprocess'); ?>   <!-- ini tambahannya -->
                        <?php echo form_open('backend/addslideprocess'); ?>  
