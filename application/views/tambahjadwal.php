                    ...
                    <div class="panel panel-default">
                        ...
                        ?>
                            <div class="alert alert-success">
                                <a href="#" class="alert-link">Berhasil Menambahkan Jadwal</a>
                            </div>
                        <?php 
                        } } ?>  

                        <?php echo form_open_multipart('backend/addjadwalprocess'); ?>   <!-- ini tambahannya -->
                        <?php echo form_open('backend/addjadwalprocess'); ?>  
                            <input class="form-control" type="text" name="nama_kegiatan" maxlength="250" id="nama_kegiatan" placeholder="Nama Kegiatan" style="width:250px;">  
                            <br>    
                            <div class="date" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                            <input class="form-control datepicker"  data-date-format="yyyy-mm-dd" type="text" name="tanggal_kegiatan" style="width:250px" placeholder="Tanggal Kegiatan" >
                            </div>
                            <input type="hidden" id="dtp_input2" value=""/>
                            <br> 
                            <input class="form-control" type="text" name="waktu" maxlength="250" id="waktu" placeholder="Waktu Kegiatan" style="width:250px;">         
                            <br>
