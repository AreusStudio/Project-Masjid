...
font-size:12px;
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Tambah Data Keuangan</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
         <!-- /.row -->
                    ...
                    <div class="panel panel-default">
                        ...
                        ?>
                            <div class="alert alert-success">
                                <a href="#" class="alert-link">Berhasil Menambahkan Data Keuangan</a>
                            </div>
                        <?php 
                        } } ?>  

                        <?php echo form_open_multipart('backend/addkeuanganprocess'); ?>   <!-- ini tambahannya -->
                        <?php echo form_open('backend/addkeuanganprocess'); ?>  
                            <input class="form-control" type="text" name="Nama_keuangan" maxlength="250" id="Nama_keuangan" placeholder="Nama Keuangan" style="width:250px;">  
                            <br>                                  
